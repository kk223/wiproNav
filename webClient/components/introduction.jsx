...
class Introduction extends React.Component
{
    ...
    render()
    {
        const styleFunction = (screenClass) => {
            if (screenClass === 'xl')
                return {fontSize: '20px', backgroundImage: `url(${ '../images/background.jpg'})`, backgroundSize: 'cover',height:'100vh'};
            if (screenClass === 'lg')
                return {fontSize: '20px', backgroundImage: `url(${ '../images/background.jpg'})`, backgroundSize: 'cover',height:'100vh'};
            if (screenClass === 'md')
                return {fontSize: '18px', backgroundImage: `url(${ '../images/background.jpg'})`, backgroundSize: 'cover',height:'100vh'};
            if (screenClass === 'sm')
                return {fontSize: '15px', backgroundImage: `url(${ '../images/background.jpg'})`, backgroundSize: 'cover',height:'100vh'};
            return {fontSize: '10px', backgroundImage: `url(${ '../images/background.jpg'})`, backgroundSize: 'cover',height:'100vh'};
        };
